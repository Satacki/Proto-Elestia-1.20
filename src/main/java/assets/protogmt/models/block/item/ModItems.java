package assets.protogmt.models.block.item;
...
import assets.protogmt.models.block.item.custom.*;
...
public class ModItems {
    ...
    public static final Item MITHRIL_TOOL_UPGRADE = registerItem("mithril_tool_upgrade",
...
//Chesium
    ...
    public static final Item MITHRIL_SWORD = registerItem("mithril_sword",
        ...
        private static Item registerItem(String name, Item item) {
            return Registry.register(Registries.ITEM, new Identifier(ProtoGMT.MOD_ID, name), item);
        }
