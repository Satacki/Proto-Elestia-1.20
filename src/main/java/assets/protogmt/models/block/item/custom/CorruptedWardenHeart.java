...
public class CorruptedWardenHeart extends Item {
    ...
    public void appendTooltip(ItemStack stack, @Nullable World world, List<Text> tooltip, TooltipContext context) {
        if(Screen.hasShiftDown()) {
            tooltip.add(Text.translatable("item.protogmt.warden_heart_corrupted.tooltip.shiftkey"));
        } else {
            tooltip.add(Text.translatable("item.protogmt.warden_heart_corrupted.tooltip"));
        }
    }
