...
public class ModModelProvider extends FabricModelProvider {
    ...
    public void generateItemModels(ItemModelGenerators gen) {
        ...
        gen.generateFlatItem(ModItems.IDOFRONT_MASK, ModelTemplates.FLAT_ITEM);
        gen.generateFlatItem(ModItems.IDOFRONT_CHESTPLATE, ModelTemplates.FLAT_ITEM);
        gen.generateFlatItem(ModItems.IDOFRONT_LEGGINGS, ModelTemplates.FLAT_ITEM);
        gen.generateFlatItem(ModItems.IDOFRONT_BOOTS, ModelTemplates.FLAT_ITEM);
