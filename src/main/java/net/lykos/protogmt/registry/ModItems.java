...
public class ModItems {
    ...
    public static final Item IDOFRONT = registerItem(
            "idofront",
            new Item(new FabricItemSettings())
    );
    ...
    public static final Item CARTRIDGE = registerItem(
            "cartridge",
            new CartridgeItem(new FabricItemSettings().rarity(Rarity.UNCOMMON)));
    ...
    public static final Item IDOFRONT_MASK = registerItem(
            "idofront_mask",
            new IdofrontArmorItem(
                    ModArmorMaterials.IDOFRONT,
                    ArmorItem.Type.HELMET,
                    new FabricItemSettings().rarity(Rarity.RARE)
            )
    );

    public static final Item IDOFRONT_CHESTPLATE = registerItem(
            "idofront_chestplate",
            new IdofrontArmorItem(
                    ModArmorMaterials.IDOFRONT,
                    ArmorItem.Type.CHESTPLATE,
    ...
    public static final Item IDOFRONT_LEGGINGS = registerItem(
            "idofront_leggings",
            new IdofrontArmorItem(
                    ModArmorMaterials.IDOFRONT,
                    ArmorItem.Type.LEGGINGS,
    ...
    public static final Item IDOFRONT_BOOTS = registerItem(
            "idofront_boots",
            new IdofrontArmorItem(
                    ModArmorMaterials.IDOFRONT,
                    ArmorItem.Type.BOOTS,
